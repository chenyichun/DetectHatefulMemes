...
class Meme(Dataset):
    def __init__(self, image_set, root_path, data_path, boxes='gt', proposal_source='official',
        ...
        proposal_dets = 'meme/proposal/res101_coco_minus_refer_notime_dets.json'
        proposal_masks = 'meme/proposal/res101_coco_minus_refer_notime_masks.json'
    ...
    def load_annotations(self):
        ...
        db_cache_name = 'meme_boxes_{}_{}'.format(self.boxes, '+'.join(self.image_sets))
        if self.zip_mode:
