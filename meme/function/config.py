...
####### Add parameters related to multitasking and class weighting #######
_C.NETWORK.WEIGHT_OF_CLASS_ONE = 5200.0 / 2800.0
_C.NETWORK.FINAL_MLP_DIMS = 6
_C.NETWORK.PSEUDO_IMG_SA_WEIGHT = 0.1
_C.NETWORK.PSEUDO_IMG_SA_INDICES = (1, 4)
_C.NETWORK.PSEUDO_TEXT_SA_WEIGHT = 0.2
_C.NETWORK.PSEUDO_TEXT_SA_INDICES = (4, 5)
_C.NETWORK.PSEUDO_BOTH_SA_WEIGHT = 0.3
_C.NETWORK.PSEUDO_BOTH_SA_INDICES = (5, 6)
